...
utils.decodeCred = function(credString) {
    ...
    let asciiString = Buffer.from(b64String, "base64").toString("ascii"); // 'mathildeeh:heihei'

    //extract the username - using regex
    cred.username = asciiString.replace(/:.*/, ""); //mathildeeh

    //extract the password
    cred.password = asciiString.replace(cred.username + ":", ""); //heihei
